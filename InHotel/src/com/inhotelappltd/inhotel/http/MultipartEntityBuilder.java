...
package com.inhotelappltd.inhotel.http;
...
import com.inhotelappltd.inhotel.http.content.ByteArrayBody;
import com.inhotelappltd.inhotel.http.content.FileBody;
import com.inhotelappltd.inhotel.http.content.InputStreamBody;
import com.inhotelappltd.inhotel.http.content.StringBody;
...
public class MultipartEntityBuilder {
	...
	public MultipartEntityBuilder addTextBody(final String name,
		...
		this.bodyParts.add(new FormBodyPart(name, new StringBody(text,
				contentType)));
		return this;
	}
	...
	public MultipartEntityBuilder addBinaryBody(final String name,
			final byte[] b, final ContentType contentType, final String filename) {
		if (this.bodyParts == null) {
			this.bodyParts = new ArrayList<FormBodyPart>();
		}
		this.bodyParts.add(new FormBodyPart(name, new ByteArrayBody(b,
	...
	public MultipartEntityBuilder addPart(final String name,
	...
	public MultipartEntityBuilder addBinaryBody(final String name,
		...
		this.bodyParts.add(new FormBodyPart(name, new FileBody(file,
				contentType, filename)));
		return this;
	}
	...
	public MultipartEntityBuilder addBinaryBody(final String name,
		...
		this.bodyParts.add(new FormBodyPart(name, new InputStreamBody(stream,
				contentType, filename)));
		return this;
	}
	...
	public MultipartEntity build() {
		final MultipartEntity e = new MultipartEntity(
				this.lax ? HttpMultipartMode.BROWSER_COMPATIBLE
						: HttpMultipartMode.STRICT, this.boundary, this.charset);
		if (this.bodyParts != null) {
