...
public class PlayServicesHelper {
    ...
    private static final String PROPERTY_REG_ID_Quickblox = "registration_id_q";
    ...
    private void checkPlayService() {
        ...
        if (checkPlayServices()) {
			...
			.setMessage("Google Play service is not avilable !!")
    ...
    private String getRegistrationId() {
        ...
        String registrationId = prefs.getString(PROPERTY_REG_ID_Quickblox, "");
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    regId = googleCloudMessaging.register(CommonActions.PROJECT_NUMBER);
    ...
    /*    final TelephonyManager mTelephony = (TelephonyManager) activity.getSystemService(
		...
		Log.e("subscribeToPushNotifications", deviceId + "@@@regId "+ regId);
    ...
    private void storeRegistrationId(String regId) {
        ...
        editor.putString(PROPERTY_REG_ID_Quickblox, regId);
